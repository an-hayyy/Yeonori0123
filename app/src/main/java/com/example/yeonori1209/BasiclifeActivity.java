...
public class BasiclifeActivity extends AppCompatActivity implements YouTubePlayer.OnInitializedListener{

    public static final String API_KEY = "AIzaSyCmQvbIqHA1o9JyUldBvVudV7-GWZbjZ5s";
    public static final String VIDEO_ID = "m_SW5HIkXiw";
    ...
    private com.example.yeonori1209.BasiclifeActivity.MyPlayerStateChangeListener myPlayerStateChangeListener;
    private com.example.yeonori1209.BasiclifeActivity.MyPlaybackEventListener myPlaybackEventListener;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        myPlayerStateChangeListener = new com.example.yeonori1209.BasiclifeActivity.MyPlayerStateChangeListener();
