...
public class ExperienceActivity02_6 extends AppCompatActivity implements YouTubePlayer.OnInitializedListener{

    public static final String API_KEY = "AIzaSyCmQvbIqHA1o9JyUldBvVudV7-GWZbjZ5s";
    public static final String VIDEO_ID = "YHA4NsRgrWQ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_experience02_6);
