...
public class SoS02Activity extends AppCompatActivity implements YouTubePlayer.OnInitializedListener {

    public static final String API_KEY = "AIzaSyCmQvbIqHA1o9JyUldBvVudV7-GWZbjZ5s";
    public static final String VIDEO_ID = "O47O4oGVwrU";
    ...
    private com.example.yeonori1209.SoS02Activity.MyPlayerStateChangeListener myPlayerStateChangeListener;
    private com.example.yeonori1209.SoS02Activity.MyPlaybackEventListener myPlaybackEventListener;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sos02);
